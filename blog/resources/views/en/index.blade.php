                ...
                <div class="layer1 layer">
                    ...
                    <form action="">
                        <div class="form_line">
                            ...
                            <div>
                                <label><input type="radio" name="type_3">Solo</label>
                                <label><input type="radio" name="type_3">Team</label>
                            </div>
                        </div>
                        <div class="form_line">
                        ...
                        <div class="form_line">
                            ...
                            <label>
                                ...
                                <br/>
                                <span>
                                    * Please enter the email you entered when applying.
                                </span>
                            </label>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $('.con_bg2 .attend_box').click(function(){
            if($("input:checkbox[name=check1]").is(":checked") == false){
                alert('You are required to agree to the Privacy Policy.');
