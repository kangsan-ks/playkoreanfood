...
<html lang="ko">
    ...
    <body>
        <div id="container">
            ...
            <div id="nav">
                <div class="logo">
                    <a href="/as_admin/main_set">
                        <img src="/img/kr/logo2.png" alt="로고" width="100%">
                    </a>
                </div>
                <div class="nav_title">
                    <span>ADMIN</span><a href="/as_admin/main_set"><i class="fas fa-sign-out-alt"></i></a>
                </div>
                <div class="nav_con">
                    <div class="na_title nav_img"><i class="fas fa-desktop"></i>메인페이지 설정</div>
                    <div class="na_title dep2">
                        <div class="nav_sub"><a href="/as_admin/main_set">메인 페이지</a></div>
                    </div>
                    <div class="na_title nav_img"><i class="far fa-clipboard"></i>문의 & 참가신청</div>
                    <div class="na_title dep2">
                        <div class="nav_sub"><a href="/as_admin/contest/list">참가신청 게시판</a></div>
                        <div class="nav_sub"><a href="/as_admin/inquiry/list">문의 게시판</a></div>
                    </div>
                </div>
            </div>
            <div id="con">
